...
dtype_dict = {
    col: np.float32 for col in [
        'tas', 'T_TARGET', 'LC_CORINE', 'IMPERV', 'HEIGHT', 'COAST', 'ELEV', 'POP', 'RH',
        'SP', 'PRECIP', 'wind_speed', 'TCC', 'CAPE', 'BLH', 'SSR', 'SOLAR_ELEV', 'DECL'
    ]
}

# File path
file_path = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_1km/train_val/CLUSTER1_TEST_1km.csv'
...
file_path = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_1km/train_val/CLUSTER1_TRAIN_1km.csv'
...
with open('run_time_CL1.txt', 'a') as f:
...
train = train[['LC_CORINE', 'IMPERV', 'HEIGHT', 'COAST', 'ELEV', 'POP', 'RH', 'SP', 'PRECIP','T2M', 'WS', 'TCC',  'CAPE', 'BLH', 'SSR','SOLAR_ELEV', 'DECL']].astype(np.float32)

y_val = val['T2M_difference'].astype(np.float32)
val = val[['LC_CORINE', 'IMPERV', 'HEIGHT', 'COAST', 'ELEV', 'POP', 'RH', 'SP', 'PRECIP','T2M', 'WS', 'TCC',  'CAPE', 'BLH', 'SSR','SOLAR_ELEV', 'DECL']].astype(np.float32)
...
joblib.dump(rf, "/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_1km/models/model_1km_CL1.joblib")
