...
raster_path = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/data/height/GHS_BUILT_S_E2030_GLOBE_R2023A_54009_1000_V1_0.tif'
raster = rxr.open_rasterio(raster_path, parse_coordinates=True, masked=True)

# Create a directory to store the .nc files
output_dir = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_1km/model_1km_reference'
...
def modify_variable_string(input_string):
    ...
    modified_string = 'km1_'+ city_name + '.nc'
