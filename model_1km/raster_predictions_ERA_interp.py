...
data_path = "/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_1km/raster_total_CORINE_perc_ERA_interp"
output_path = "/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_1km/raster_pred_ERA_interp"
...
# Load models
models = {
    1: joblib.load(os.path.join(models_path, "model_1km_CL1_ERA_interp.joblib")),
    2: joblib.load(os.path.join(models_path, "model_1km_CL2_ERA_interp.joblib")),
    3: joblib.load(os.path.join(models_path, "model_1km_CL3_ERA_interp.joblib")),
}
...
columns_order = ["LC_1_perc", "LC_2_perc", "LC_3_perc", "LC_4_perc", "LC_5_perc", 
...
for _, row in city_assignments.iterrows():
    ...
    city_data_file = os.path.join(data_path, f"Total_{city}_CORINE_perc.csv")
