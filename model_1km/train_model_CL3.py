...
file_path = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_1km/train_val/CLUSTER3_TEST_1km.csv'
val = pd.read_csv(file_path, usecols=[ 'city','tas', 'T_TARGET', 'LC_CORINE', 'IMPERV', 'HEIGHT', 'COAST', 'ELEV', 'POP', 'RH', 'SP', 'PRECIP', 'wind_speed', 'TCC', 'CAPE', 'BLH', 'SSR','SOLAR_ELEV', 'DECL'], low_memory=False)

file_path = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_1km/train_val/CLUSTER3_TRAIN_1km.csv'
train = pd.read_csv(file_path, usecols=['city','tas', 'T_TARGET','LC_CORINE', 'IMPERV', 'HEIGHT',  'COAST', 'ELEV', 'POP', 'RH', 'SP', 'PRECIP', 'wind_speed', 'TCC', 'CAPE', 'BLH', 'SSR','SOLAR_ELEV', 'DECL'], low_memory=False)
...
with open('run_time_CL3.txt', 'a') as f:
...
joblib.dump(rf, "/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_1km/models/model_1km_CL3.joblib")
