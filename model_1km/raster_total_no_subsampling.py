...
output_directory = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_1km/raster_total_no_subsampling'

# Ensure the output directory exists
os.makedirs(output_directory, exist_ok=True)
filename = "Amsterdam_total.nc"
...
for i in [1,2]: #filename in os.listdir(input_directory):
    ...
    if filename.endswith('.nc'):  # Check if the file is a netCDF file
        ...
        elev_path = os.path.join(elev_directory, 'elev_km1_' + city_name + '.nc')
