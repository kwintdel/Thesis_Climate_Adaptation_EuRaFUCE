...
ERA_solar_date_directory = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_1km/ERA_solar_new_percity'
ERA_RH_date_directory = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_1km/ERA_RH_new_percity'
...
CORINE_directory = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_1km/CORINE_new'
geopot_directory = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_1km/geopot_new'
output_directory = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_1km/raster_total'
...
for filename in os.listdir(input_directory):
    if filename.endswith('.nc'):
        ...
        CORINE_path = os.path.join(CORINE_directory, 'CORINE_km1_' + city_name + ".nc")
        ...
        # Process CORINE data (this is done separately due to the change of CORINE to UrbClim classes)
        ...
        print(f"common times:  {common_times_df} \n")
        ...
        print(f"selected times:  {selected_times_df} \n")
        ...
        # spatial subsampling (2% of every LC class)
        #---------------------------------------------------------------------------------
