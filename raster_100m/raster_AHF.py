...
file_path = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/data/AHF/AHF_world.nc'
ds =xr.open_dataset(file_path)

# Function to replace "tas_" with "AHF" and remove the "_UrbClim_2015_09_v1.0" part
def modify_variable_string(input_string):
    modified_string = 'AHF_' + input_string
...
output_directory = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/raster_EU/AHF_new'
