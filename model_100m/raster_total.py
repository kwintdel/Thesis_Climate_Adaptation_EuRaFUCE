...
ERA_solar_date_directory = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_100m/ERA_solar_new_percity'
ERA_RH_date_directory = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_100m/ERA_RH_new_percity'
coast_directory = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_100m/coast_new'
elev_directory = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_100m/elev_DMET_new'
height_directory = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_100m/height_new'
imperv_directory = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_100m/imperv_new'
population_directory = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_100m/population_new'
CORINE_directory = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_100m/CORINE_new'
geopot_directory = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_100m/geopot_new'
output_directory = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_100m/raster_total'
...
for filename in os.listdir(input_directory):
    if filename.endswith('.nc'):  # Check if the file is a netCDF file
        ...
        city_name = filename.replace('m100_','').replace('.nc', '')  # Extract city name from filename
        ...
        #ERA_path = os.path.join(ERA_solar_date_directory, 'm100_' + city_name + '_ERA_solar_total.nc')
        #ERA_RH_path = os.path.join(ERA_RH_date_directory, 'm100_' + city_name + '_ERA_RH_total.nc')
        ...
        dataframes = [coast_df, elev_df, height_df, imperv_df, population_df, corine_df] #dataframes = [coast_df, elev_df, height_df, imperv_df, population_df, corine_df, ERA_df, ERA_RH_df, geopot_df]
        names = ["coast_df", "elev_df", "height_df", "imperv_df", "population_df", "corine_df"] #names = ["coast_df", "elev_df", "height_df", "imperv_df", "population_df", "corine_df", "ERA_df", "ERA_RH_df", "geopot_df"]
        ...
        static_data.to_csv(output_file, index=False)
