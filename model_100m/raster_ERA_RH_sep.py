...
output_dir = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/model_100m/ERA_RH_new_sep'

# Loop over all ERA5 files in the era_dir
for era5_file in os.listdir(era_dir):
    if era5_file.endswith(".nc"):

        month = era5_file[13:15]  # Extract 'mm' from 'ERA_yyyy_mm.nc'
