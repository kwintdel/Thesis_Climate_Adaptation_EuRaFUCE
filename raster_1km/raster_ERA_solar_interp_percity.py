...
input_base_dir = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/raster_1km/ERA_solar_interp_sep'
output_dir = '/data/gent/vo/000/gvo00041/Kwint_personal/UrbClim_Emulator/ownscripts/raster_1km/ERA_solar_interp_percity'
...
for city_folder in os.listdir(input_base_dir):
    ...
    if os.path.isdir(city_path):  # Ensure it is a folder
        ...
        output_path = os.path.join(output_dir, f"{city_folder}_ERA_solar_total.nc")
